...
var republics = [
  {
    ...
    price: 200,
    city: 'Caraguatatuba',
    primary: require('../../images/RepublicList/RepublicExample2.jpg'),
  },
  {
    id: '01',
    ...
    price: 250,
    city: 'Caraguatatuba',
    primary: require('../../images/RepublicList/RepublicExample3.jpg'),
  },
  {
    id: '02',
    name: 'Doc Hudson',
    price: 300,
    city: 'Caraguatatuba',
    primary: require('../../images/RepublicList/RepublicExample.png'),
  },
  {
    id: '04',
    name: 'Coalas Ramirez',
  ...
  },
  {
    ...
    price: 450,
    city: 'Caraguatatuba',
    primary: require('../../images/RepublicList/RepublicExample4.jpg'),
  },
  {
    id: '06',
    name: 'Os caras',
          ...
          return (
            <TouchableHighlight onPress={navigateToRepublic}>
              <View style={styles.Republic}>
                <Text style={styles.RepublicTitle}>{item.name}</Text>
                <View style={styles.ImageRepublicDetail}>
                  <Image style={styles.ImageRepublic} source={item.primary} />
                </View>
                <View style={styles.RepublicDescription}>
                  ...
                  <View style={styles.RepublicDescriptionPrice}>
                    <Text style={styles.RepublicTextPrice}>
                      R${item.price},00
                    </Text>
  ...
  return (
    <FlatList
      ...
      renderItem={({ item }) => {
        ...
        return <Text style={styles.TextFiltered}>{item.name}</Text>;
      }}
    />
  );
}
